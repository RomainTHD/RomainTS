...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    let all = {
      doesReturn: _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.False,
    ...
    for (const stmt of node.statements) {
      ...
      if (!env.config.allowUnreachableCode && all.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.True) {
        throw new ___WEBPACK_IMPORTED_MODULE_1__.TypecheckingFailure("Unreachable code detected", stmt);
      }
      if (current.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.True) {
        /*
        ```
        if (something) {
            return "s";
        ...
        Does return: yes
         */
        all.doesReturn = _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.True;
      ...
      } else if (current.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.Sometimes) {
        if (all.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.False) {
          /*
          ```
          if (something) {
              return "s";
           ...
           */
          all.inferredType.add(current.inferredType);
        } else if (all.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.True) {
          /*
          ```
          return 0;
          if (something) {
