...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    for (const element of node.elements) {
      const e = yield ___WEBPACK_IMPORTED_MODULE_1__.TypeChecker.accept(element, env);
      let t = e.eType;
    ...
    let t;
    if (types.length === 0) {
      t = _types__WEBPACK_IMPORTED_MODULE_2__.ArrayType.create(_types__WEBPACK_IMPORTED_MODULE_2__.AnyType.create());
    } else {
      t = _types__WEBPACK_IMPORTED_MODULE_2__.ArrayType.create(_types__WEBPACK_IMPORTED_MODULE_2__.UnionType.create(types).simplify());
    }
    return {
      eType: t
    };
