...
/* harmony import */ var _env__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../env */ 5231);
...
function _visit() {
  _visit = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    env.setValueSide(_env__WEBPACK_IMPORTED_MODULE_5__.ValueSide.LValue);
    const name = yield _accept__WEBPACK_IMPORTED_MODULE_4__.TypeChecker.accept(node.name, env);
    env.setValueSide(_env__WEBPACK_IMPORTED_MODULE_5__.ValueSide.RValue);
