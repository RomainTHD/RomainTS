"use strict";
(self["webpackChunkromaints"] = self["webpackChunkromaints"] || []).push([[5883],{

/***/ 5883:
/*!*********************************************************************!*\
  !*** ../src/typechecker/visitor/statement/WhileStatementVisitor.ts ***!
  \*********************************************************************/
...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    if (!env.config.allowUnreachableCode) {
      if (e.eType instanceof _types__WEBPACK_IMPORTED_MODULE_2__.LiteralType) {
        if (e.eType.literal.value === true) {
          // Do something
        } else if (e.eType.literal.value === false) {
          throw new ___WEBPACK_IMPORTED_MODULE_1__.TypecheckingFailure("While body will be unreachable", node.expression);
        }
      }
    }
