...
const logger = _utils_Logger__WEBPACK_IMPORTED_MODULE_1__.LoggerFactory.create("EqualsTokenVisitor");
function visit(_x, _x2, _x3) {
  return _visit.apply(this, arguments);
}
function _visit() {
  _visit = (0,D_GDrive_Programmation_TypeScript_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env, {
    left,
    right
  }) {
