...
/* harmony import */ var _utils_NotImplementedException__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../utils/NotImplementedException */ 7971);
...
function _visit() {
  _visit = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    if (node.modifiers) {
      throw new _utils_NotImplementedException__WEBPACK_IMPORTED_MODULE_1__.NotImplementedException();
    }
    ...
    const t = yield _accept__WEBPACK_IMPORTED_MODULE_2__.TypeChecker.accept(node.type, env);
    env.addType(name, t);
  });
  return _visit.apply(this, arguments);
}
