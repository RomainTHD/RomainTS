  ...
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    switch (node.operator) {
      ...
      case (typescript__WEBPACK_IMPORTED_MODULE_1___default().SyntaxKind).MinusMinusToken:
        if (!e.isFromVariable) {
          throw new ___WEBPACK_IMPORTED_MODULE_2__.TypecheckingFailure("Cannot use prefix unary operator on non-variable", node);
        }
        if (!e.isMutable) {
          throw new ___WEBPACK_IMPORTED_MODULE_2__.TypecheckingFailure("Cannot use prefix unary operator on immutable variable", node);
        }
