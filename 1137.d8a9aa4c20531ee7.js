...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    if (!(expr instanceof _types__WEBPACK_IMPORTED_MODULE_2__.PropertyAccessor)) {
      throw new ___WEBPACK_IMPORTED_MODULE_1__.TypecheckingFailure(`Property access on non-object type '${expr}'`, node);
    }
    if (expr.hasProperty(prop)) {
      return expr.getProperty(prop);
    }
    if (env.config.strictMode) {
      throw new ___WEBPACK_IMPORTED_MODULE_1__.TypecheckingFailure(`Property '${prop}' does not exist on type '${expr}'`, node);
    } else {
      return _types__WEBPACK_IMPORTED_MODULE_2__.UndefinedType.create();
    }
  });
