"use strict";
(self["webpackChunkromaints"] = self["webpackChunkromaints"] || []).push([[9155],{

/***/ 9155:
/*!*************************************************************!*\
  !*** ../src/typechecker/visitor/other/CaseClauseVisitor.ts ***!
  \*************************************************************/
...
function _visit() {
  _visit = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    const switchExprType = env.getData("switchExprType", true);
    env.enterScope();
    const caseExpr = yield ___WEBPACK_IMPORTED_MODULE_1__.TypeChecker.accept(node.expression, env);
    if (!switchExprType.contains(caseExpr.eType)) {
      throw new ___WEBPACK_IMPORTED_MODULE_1__.TypecheckingFailure("Case expression type doesn't match switch expression type", node);
    }
