...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    if (node.expression) {
      ...
      t = _types__WEBPACK_IMPORTED_MODULE_2__.VoidType.create();
    }
    ...
    if (!retType.contains(t)) {
      throw new ___WEBPACK_IMPORTED_MODULE_1__.TypecheckingFailure(`Cannot return type '${t}' from function with return type '${retType}'`, node);
    }
    return {
      doesReturn: _utils_Bool3__WEBPACK_IMPORTED_MODULE_3__.Bool3.True,
      inferredType: t
    };
  });
