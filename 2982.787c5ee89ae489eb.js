...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    return _types__WEBPACK_IMPORTED_MODULE_2__.UnionType.create([_types__WEBPACK_IMPORTED_MODULE_2__.LiteralType.create({
      vType: _types__WEBPACK_IMPORTED_MODULE_2__.StringType.create(),
      value: "string"
    }), _types__WEBPACK_IMPORTED_MODULE_2__.LiteralType.create({
      vType: _types__WEBPACK_IMPORTED_MODULE_2__.StringType.create(),
      value: "number"
    }), _types__WEBPACK_IMPORTED_MODULE_2__.LiteralType.create({
      vType: _types__WEBPACK_IMPORTED_MODULE_2__.StringType.create(),
