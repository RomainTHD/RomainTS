...
function _visit() {
  _visit = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    const {
      fType,
      infer
    } = yield (0,_shared_function__WEBPACK_IMPORTED_MODULE_6__.visitFunction)(env, node.parameters, node.type);
    if (!node.body) {
    ...
    if (retData.doesReturn !== _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.True && ![_types__WEBPACK_IMPORTED_MODULE_2__.VoidType.create(), _types__WEBPACK_IMPORTED_MODULE_2__.AnyType.create(), _types__WEBPACK_IMPORTED_MODULE_2__.UndefinedType.create()].some(t => fType.retType.contains(t))) {
    ...
    if (infer && fType.retType.equals(_types__WEBPACK_IMPORTED_MODULE_2__.AnyType.create())) {
      ...
      if (retData.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.False) {
        fType.retType = _types__WEBPACK_IMPORTED_MODULE_2__.VoidType.create();
      } else if (retData.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.Sometimes) {
