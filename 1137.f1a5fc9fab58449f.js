...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    const expr = yield env.withChildData({
      ...
      return yield ___WEBPACK_IMPORTED_MODULE_1__.TypeChecker.accept(node.expression, env);
    }));
    ...
    if (expr.eType instanceof _types__WEBPACK_IMPORTED_MODULE_2__.ArrayType && propType.pType instanceof _types__WEBPACK_IMPORTED_MODULE_2__.FunctionType && propType.pType.generics.length === 1) {
      // `t.pop`;
      return {
        // FIXME: Hardcoded generics name
        eType: propType.pType.replaceGenerics([{
          name: "T",
          gType: expr.eType.baseType
        }]),
        isFromVariable: true,
        isMutable: true
      };
