...
const visit = /*#__PURE__*/function () {
  var _ref = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    if (!node.elseStatement) {
      return {
        doesReturn: thenBlock.doesReturn === _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.False ? _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.False : _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.Sometimes,
    ...
    env.leaveScope();
    return {
      doesReturn: _utils_Bool3__WEBPACK_IMPORTED_MODULE_4__.Bool3.and(thenBlock.doesReturn, elseBlock.doesReturn),
