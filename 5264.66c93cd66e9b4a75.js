"use strict";
(self["webpackChunkromaints"] = self["webpackChunkromaints"] || []).push([[5264],{

/***/ 5264:
/*!*********************************************************************!*\
  !*** ../src/typechecker/visitor/other/PropertyAssignmentVisitor.ts ***!
  \*********************************************************************/
...
function _visit() {
  _visit = (0,_home_runner_work_RomainTS_RomainTS_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    const expr = yield ___WEBPACK_IMPORTED_MODULE_1__.TypeChecker.accept(node.initializer, env);
    const nameExpr = yield env.withChildData({
    ...
    (0,_utils__WEBPACK_IMPORTED_MODULE_2__.assert)(nameExpr.identifier !== undefined, "identifier is undefined");
    return {
      name: nameExpr.identifier,
      pType: expr.eType.generalize()
    };
  });
  return _visit.apply(this, arguments);
}
