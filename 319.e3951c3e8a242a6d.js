"use strict";
(self["webpackChunkRomainTS_demo"] = self["webpackChunkRomainTS_demo"] || []).push([[319],{
...
function _visit() {
  _visit = (0,C_WSL_romaints_demo_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (node, env) {
    ...
    if (retData.doesReturn !== _utils_Bool3__WEBPACK_IMPORTED_MODULE_3__.Bool3.True && ![_types__WEBPACK_IMPORTED_MODULE_2__.VoidType.get(), _types__WEBPACK_IMPORTED_MODULE_2__.AnyType.get(), _types__WEBPACK_IMPORTED_MODULE_2__.UndefinedType.get()].some(t => t.equals(fType.retType))) {
    ...
    env.popReturnType();
    env.exitScope();
    if (infer && fType.retType.equals(_types__WEBPACK_IMPORTED_MODULE_2__.AnyType.get()) && retData.inferredType) {
